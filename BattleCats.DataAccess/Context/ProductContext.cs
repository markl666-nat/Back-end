    ...
    public class ProductContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DescriptionAdvanced>().HasData(
                ...
                new DescriptionAdvanced { Id = 7, Health = 6500, Attack = 1300, Range = 410 },    
                new DescriptionAdvanced { Id = 8, Health = 1800, Attack = 360, Range = 220 },     
                new DescriptionAdvanced { Id = 9, Health = 9999, Attack = 1500, Range = 480 },    
                new DescriptionAdvanced { Id = 10, Health = 2400, Attack = 420, Range = 260 },    
                new DescriptionAdvanced { Id = 11, Health = 3300, Attack = 660, Range = 240 },    
                new DescriptionAdvanced { Id = 12, Health = 1600, Attack = 280, Range = 130 }    
            );
